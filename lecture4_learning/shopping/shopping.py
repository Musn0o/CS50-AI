...
def load_data(filename):
    ...
    with open(filename) as f:
        ...
        for row in reader:
            # Process evidence features according to specifications
            row_evidence = []
            ...
            # Month - integer (0-11)
            row_evidence.append(month_mapping[row["Month"]])
...
def evaluate(labels, predictions):
    ...
    """
    true_positives = 0  # Actual positive and predicted positive
    true_negatives = 0  # Actual negative and predicted negative
    actual_positives = 0  # Actual positive
    actual_negatives = 0  # Actual negative
